...
from models.models import User, ScheduledMessage, MessageStatus
        ...
        try:
            ...
            for scheduled_msg in due_messages:
                try:
                    ...
                    if not user:
                        logger.warning(f"User {scheduled_msg.user_id} not found for scheduled message {scheduled_msg.id}")
